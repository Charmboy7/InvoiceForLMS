...
const ExamFeeDetails = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://localhost:8080/payments/examfee/${studentId}`);
                ...
                <div className="col-md-4">
                  <div className="card">
                    ...
                    <ul className="list-group list-group-flush">
                      ...
                      <li className="list-group-item"><strong>Contact Email:</strong> {item[13]}</li>
                    </ul>
                  </div>
                </div>
